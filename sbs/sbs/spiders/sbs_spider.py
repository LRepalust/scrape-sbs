...
class SbsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        category_urls = response.css(
            '#maincontent .container + .a-panel.a-panel--list a.item__link::attr(href)').getall()
    ...
    def parse_items(self, response):
        ...
        loader.add_css('category', '.breadcrumb a::text',
                       re=r'(Business Services|Health|Digital & IT|Construction & Estates)')
        ...
        loader.add_css('start_date', 'p:nth-child(6)::text')
