...
class SbsSpider(scrapy.Spider):
    ...
    def parse_items(self, response):
        ...
        l.add_css('lot_number', 'p:nth-child(10) > span > strong::text')
        l.add_css('lot_description', 'p:nth-child(10) > span > strong::text')
        l.add_css('lot_number', '.p:nth-child(12)::text')
        l.add_css('lot_description', 'p:nth-child(12)::text')
        l.add_css('lot_number', 'p:nth-child(11) > span > strong::text')
        l.add_css('lot_description', 'p:nth-child(11) > span > strong::text')
        l.add_css('lot_number', 'p:nth-child(10) > span::text')
        l.add_css('lot_description', 'p:nth-child(10) > span::text')
        l.add_css('lot_number', 'p:nth-child(10)>a::text')
        l.add_css('lot_description', 'p:nth-child(10)>a::text')
        l.add_css('lot_number', 'h3>span::text')
        l.add_css('lot_description', 'h3>span::text')
        l.add_css('lot_number', 'p:nth-child(15)>span::text')
        l.add_css('lot_description', 'p:nth-child(15)>span::text')
        l.add_css('lot_number', 'tr>td::text')
        l.add_css('lot_description', 'tr>td::text')
        l.add_xpath('supplier_name', '//td//text()')
        yield l.load_item()
